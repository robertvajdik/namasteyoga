...
function ny_ensure_content_tables(): void {
    ...
    if ($c === 0) {
        ...
        $seed = [
            ['Klára',     'Hatha, Vinyasa',           'Vede klidnou i dynamickou praxi. Baví ji propojení dechu a pohybu.',      10],
            ['Lenka',     'Vinyasa, Power',           'Silná, tekoucí praxe. Skvělá pro ty, kdo chtějí zapotit se.',              20],
            ['Jitka',     'Yin, Restorative',         'Klid, dech a čas. Vhodné jako protipól rušného týdne.',                    30],
            ['Tomáš',     'Ashtanga Mysore',          'Vede sebeřízenou ashtangovou praxi pro pravidelné praktikující.',          40],
            ['Eva',       'Prenatal, Pánevní dno',    'Specialistka na prenatal a poporodní praxi.',                              50],
            ['Christina', 'Restorative, Pilates',     'Regenerace a práce s hlubokým středem.',                                   60],
        ];
