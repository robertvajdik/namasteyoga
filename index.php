...
?>
    <section class="day <?= $isPast ? 'is-past' : '' ?> <?= $isToday ? 'is-today' : '' ?>">
        ...
        ?>
            <article class="class-card <?= $left === 0 ? 'is-full' : '' ?>" style="border-left-color: var(--cat-<?= $cat ?>);">
                ...
                <div class="row">
                    ...
                    <?php elseif (!$user && $left > 0): ?>
                        <a class="btn btn-secondary btn-sm" href="login.php?class_date=<?= e($dateStr) ?>">Přihlásit</a>
                    <?php endif; ?>
                </div>
            </article>
